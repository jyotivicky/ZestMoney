...
import com.aventstack.extentreports.reporter.ExtentHtmlReporter;
   ...
   public class globalVar{
	 ...
	 */
	public static final String SystemExtentReportPath = "ZestReport\\zest.html";
	...
	/*
	 * these variables are for the data read from the properties file to read data
	 * like username, password,url
	 */
