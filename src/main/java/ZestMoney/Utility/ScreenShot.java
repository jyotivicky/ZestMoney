...
import org.openqa.selenium.WebDriver;
   ...
   public class ScreenShot {
	...
	public static String CaptureScreen(WebDriver driver, String ZestMoney) {
		...
		try {
			...
			File file                         = new File("ScreenShot_Zest\\");
			String path                       = file.getAbsolutePath();
			String DescFile                   = "ScreenShot_Zest\\" + ZestMoney + "_" + Rundate + ".png";
			i++;
